<form action="<?php echo base_url(); ?>index.php/preferencial/editar" method="post">
   ...
   <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        ...
        <div class="modal-header">
            <h5 class="modal-title"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Editar atención preferencial</font></font></h5>
